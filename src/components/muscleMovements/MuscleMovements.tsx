...
const MuscleMovements = ({ isTrainingCompleted = false }: {
    ...
    const allMuscleMovementsExists = muscleMovements.every(m =>
        state?.muscle_movements.some(sm => sm.id_movement === m.id_movement)
    )
    ...
    return (
        <>
            ...
            {state?.muscle_movements ? (
                <>
                    {state.muscle_movements?.length > 0 && (
                        <List>
                                ...
                                <ListItem classes="px-0">
                                    <Card classes="border-base-content/20 list-col-grow">
                                        <CardBody classes="grid grid-cols-[1fr_auto_auto] gap-2">
                                            <FieldsetSelect
                                                legend="Lista movimientos musculares"
                                                ...
                                                ({
                                                    ...
                                                    disabled: state.muscle_movements
